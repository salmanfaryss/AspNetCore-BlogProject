...
{
    public class WriterSidbarComponent:ViewComponent
    {
        ...
        public IViewComponentResult Invoke()
        {
            ...
            ViewBag.WriterAbout  = c.writers.Where(x => x.WriterName == username).Select(y => y.WriterAboutDetail).FirstOrDefault();
